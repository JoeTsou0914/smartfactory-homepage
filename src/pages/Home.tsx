          ...
          <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              <div className="relative">
                <img src="/images/home/QAI01.png" alt="QAI系統" className="w-full h-56 object-cover" />
            ...
            <motion.div 
              ...
              className="bg-white rounded-xl shadow-lg overflow-hidden"
            >
              <img src="/images/home/Yarn Fray Detection.png" alt="毛羽感測器" className="w-full h-56 object-cover" />
              <div className="p-6">
            ...
            <motion.div 
              ...
              className="bg-white rounded-xl shadow-lg overflow-hidden"
            >
              <img src="/images/home/SCADA01.jpg" alt="控制中心系統" className="w-full h-56 object-cover" />
              <div className="p-6">
            ...
            <motion.div 
              ...
              className="bg-white rounded-xl shadow-lg overflow-hidden"
            >
              <img src="/images/home/SI01.jpg" alt="SI01通訊模組" className="w-full h-56 object-cover" />
              <div className="p-6">
        ...
        <section className="py-16 px-4">
		  ...
		  >
			<div
			  ...
			  className="marquee flex space-x-12 items-center"
			  style={{ animation: "marquee 40s linear infinite", animationPlayState: "running" }}
			>
